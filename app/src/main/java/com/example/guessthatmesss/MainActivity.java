package com.example.guessthatmesss;
...
import com.example.guessthatmesss.classification.ImageClassifier;
import com.example.guessthatmesss.classification.Result;


public class MainActivity extends AppCompatActivity {

    private View mainView;
    private DoodleCanvas canvas; // custom drawing view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        canvas = (DoodleCanvas) findViewById(R.id.canvas);
        canvas.init(); // initial drawing view
    ...
    public void onDetectClick(View view) {
        ...
        Bitmap sketch = canvas.getNormalizedBitmap(); // get resized bitmap
